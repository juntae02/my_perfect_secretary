...
- **문제 상황 1: amovej() 이동 중, stop() 명령어가 적용되지 않는 현상 발생**
...
- **문제 상황 3: 용탕 이송 중 넘침 현상 발생 (가정된 위험 상황)**
  - **상황** : 용탕 대신 블럭을 담은 상태에서 로봇이 이동하면서 **블럭이 흔들리는 상황**이 발생했습니다. 이는 실제 현장에서 **용탕의 넘침 현상**으로 이어질 수 있다고 판단하여 상황을 가정했습니다.  
